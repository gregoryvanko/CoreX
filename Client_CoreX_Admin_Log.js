class CoreXAdminLogApp{
    ...
    LoadView(ListOfUsers){
        ...
        // Type
        let DivType = CoreXBuild.Div("","CoreXAdminLogInputBox")
        DivBox.appendChild(DivType)
        DivType.appendChild(CoreXBuild.DivTexte("Type","","CoreXAdminLogText CoreXAdminLogMarginTxt",""))
        // DropDown
        let DropDown = document.createElement("select")
        DropDown.setAttribute("id", "InfoType")
        DropDown.setAttribute("class", "CoreXAdminLogText CoreXAdminLogDorpDown")
        // Type All
    ...
    GetCss(){
        ...
        <style>
            ...
            .CoreXAdminLogInputBoxSmall{
                margin-bottom: 2vh;
                width: 48%;
                margin-left: auto;
                margin-right: auto;
            }
            .CoreXAdminLogInputBox{
                margin-bottom: 2vh;
                width: 90%;
                margin-left: auto;
                margin-right: auto;
            ...
            .CoreXAdminLogInput:focus,
            .CoreXAdminLogInput.focus {
                border-color: var(--CoreX-color);
            }
            @media (hover: hover) {
                .CoreXAdminLogInput:hover{
                    border-color: var(--CoreX-color);
                }
            }

            .CoreXAdminLogDorpDown{
                ...
                background-position:
                  calc(100% - 20px) calc(1em + 0.2em),
                  calc(100% - 15px) calc(1em + 0.2em),
                  calc(100% - 4vh) 50%;
                background-size:
                  5px 5px,
                  5px 5px,
            ...
            .CoreXAdminLogDorpDown:focus {
                outline: 0;
            }
            @media (hover: hover) {
                .CoreXAdminLogDorpDown:hover{
                    cursor: pointer;
                    border-color: var(--CoreX-color);
                    box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.7);
                }
            ...
            @media screen and (min-width: 1200px)
            {
                ...
                .CoreXAdminLogInput{font-size: var(--CoreX-Max-font-size);}
            }
        </style>`
    }
}